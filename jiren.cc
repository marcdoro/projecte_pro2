...
const vector<vector<int>> Jiren::jiren_land_ = {
    {_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,b,b,b,b,b,_,_,_,_,_,_,_,_,_,_,_,_,_},
    {_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,b,b,j,c,d,d,c,b,b,_,_,_,_,_,_,_,_,_,_,_},
    {_,_,_,_,_,_,_,_,_,_,_,_,_,_,b,j,c,c,d,d,d,d,d,c,b,_,_,_,_,_,_,_,_,_,_},
    {_,_,_,_,_,_,_,_,_,_,_,_,_,b,j,c,c,d,d,d,d,d,d,d,c,b,_,_,_,_,_,_,_,_,_},
    {_,_,_,_,_,_,_,_,_,_,_,_,_,b,c,c,c,d,d,d,d,d,d,d,d,b,_,_,_,_,_,_,_,_,_},
    {_,_,_,_,b,b,b,_,_,_,_,b,j,c,c,c,d,d,d,d,d,d,d,d,d,c,b,_,b,b,b,_,_,_,_},
    {_,_,_,b,f,f,i,b,_,_,_,b,j,c,c,c,d,d,d,d,d,d,d,d,d,d,b,b,g,f,g,b,_,_,_},
    {_,_,b,f,g,g,i,i,b,_,_,b,j,j,c,c,d,d,d,d,d,c,d,d,d,b,i,g,f,f,f,b,_,_,_},
    {_,_,b,c,c,f,g,f,i,b,_,b,j,d,j,c,d,j,c,h,h,d,d,c,d,b,i,f,b,i,g,j,b,_,_},
    {_,b,c,c,c,c,b,g,g,f,g,b,b,b,c,d,c,c,j,b,b,a,d,c,d,c,b,g,b,b,b,j,j,b,_},
    {_,b,c,a,c,b,b,b,i,i,g,g,b,b,c,d,c,c,d,j,h,h,c,d,d,b,i,b,_,_,b,c,c,c,b},
    {b,c,a,a,a,b,b,_,b,i,i,i,i,b,d,j,c,c,d,d,d,d,d,d,c,b,b,_,_,_,b,c,b,c,b},
    {b,a,a,a,a,a,b,_,_,b,i,f,g,i,f,b,c,c,d,d,d,d,d,d,b,b,_,_,_,_,b,b,j,c,b},
    {b,a,c,a,b,a,b,_,_,_,b,i,i,i,i,f,b,c,c,d,d,d,d,d,b,b,_,_,_,_,_,b,b,b,_},
    {_,b,b,c,b,b,_,_,_,_,_,b,i,g,g,i,h,b,b,c,d,d,d,b,i,b,_,_,_,_,_,_,_,_,_},
    {_,_,_,b,b,_,_,_,_,b,b,b,b,i,i,g,i,h,h,b,b,b,b,i,g,b,b,b,b,_,_,_,_,_,_},
    {_,_,_,_,_,_,_,b,e,e,e,b,f,i,i,g,h,e,e,h,e,i,f,f,i,b,h,e,e,b,_,_,_,_,_},
    {_,_,_,_,_,_,b,e,e,e,e,e,b,f,i,g,i,e,h,h,h,f,b,b,e,e,e,e,e,b,_,_,_,_,_},
    {_,_,_,_,_,_,b,e,e,e,e,e,b,g,f,f,i,g,e,h,e,f,b,h,e,e,e,e,e,b,_,_,_,_,_},
    {_,_,_,_,_,_,b,e,e,e,e,e,e,b,g,i,f,f,f,g,g,f,b,b,e,e,e,e,e,b,_,_,_,_,_},
    {_,_,_,_,_,_,b,e,h,h,h,h,h,b,g,f,g,i,i,i,i,b,e,h,h,h,h,h,h,b,_,_,_,_,_},
    {_,_,_,_,_,_,b,h,h,h,h,h,h,b,h,h,g,g,g,g,f,b,e,e,h,h,h,h,b,_,_,_,_,_,_},
    {_,_,_,_,_,_,b,h,h,h,h,h,b,b,b,h,h,h,h,h,h,b,h,e,e,e,e,e,b,_,_,_,_,_,_},
    {_,_,_,_,_,_,b,b,h,h,h,e,b,b,b,b,b,b,b,b,b,b,b,h,e,e,h,b,_,_,_,_,_,_,_},
    {_,_,_,_,_,_,_,b,c,e,e,b,_,_,_,_,_,_,_,_,_,_,b,c,h,h,b,b,_,_,_,_,_,_,_},
    {_,_,_,_,_,_,_,b,c,a,a,b,_,_,_,_,_,_,_,_,_,_,_,b,c,a,b,_,_,_,_,_,_,_,_},
    {_,_,_,_,_,_,b,c,a,a,b,_,_,_,_,_,_,_,_,_,_,_,_,b,c,a,a,b,_,_,_,_,_,_,_},
    {_,_,_,_,_,_,b,c,a,a,b,_,_,_,_,_,_,_,_,_,_,_,_,_,b,c,a,a,b,_,_,_,_,_,_},
    {_,_,_,_,_,b,c,c,c,c,b,_,_,_,_,_,_,_,_,_,_,_,_,_,b,c,c,c,c,b,_,_,_,_,_},
};
